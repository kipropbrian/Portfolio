  ...
  return (
    <main className="min-h-dvh max-w-3xl min-w-[375px] mx-auto px-2 py-20 space-y-16">
        ...
        <div className="space-y-2">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <P>
                I am currently interested in the application of deep learning
                techniques, specifically leveraging convolutional neural network
                (CNN) embeddings extracted via libraries like DeepFace, for
                robust and scalable image recognition. This involves building
                end-to-end systems that encompass: efficient feature extraction
                from images; employing similarity search algorithms, including
                both traditional methods like cosine similarity and advanced
                indexing techniques such as FAISS, to enable rapid retrieval of
                similar visual data; and integrating these components within a
                microservices architecture utilizing message queues like Kafka
                for asynchronous processing and improved system resilience. My
                focus is on optimizing the balance between accuracy, speed, and
                scalability for real-world image recognition tasks.
              </P>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-10">
        ...
        <div className="space-y-2">
          <P>
            As an Engineering Manager since 2021, I manage and lead a team of
            engineers. I focus on cultivating a positive work environment and
            strive to achieve a high employee satisfaction rate by promoting
            continuous learning and supporting my teams technical and
